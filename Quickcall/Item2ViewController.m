...
- (void)viewWillAppear:(BOOL)animated {
    ...
    nameText.text = [userDefaults stringForKey:@"mail2Name"];
    contentText.text = [userDefaults stringForKey:@"mail2Address"];
    titleText.text = [userDefaults stringForKey:@"mail2Title"];
    bodyText.text = [userDefaults stringForKey:@"mail2Body"];
...
- (void)viewWillDisappear:(BOOL)animated
{
    //stocking user data
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setObject:nameText.text forKey:@"mail2Name"];
    [userDefaults setObject:contentText.text forKey:@"mail2Address"];
    [userDefaults setObject:titleText.text forKey:@"mail2Title"];
    [userDefaults setObject:bodyText.text forKey:@"mail2Body"];
    AppDelegate *delegate = (AppDelegate *)[[UIApplication sharedApplication] delegate];
    delegate.name2 = nameText.text;
    delegate.address2 = contentText.text;
    delegate.title2 = titleText.text;
    delegate.body2 = bodyText.text;
