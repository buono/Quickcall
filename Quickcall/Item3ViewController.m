...
- (void)viewWillAppear:(BOOL)animated {
    ...
    nameText.text = [userDefaults stringForKey:@"mail3Name"];
    contentText.text = [userDefaults stringForKey:@"mail3Address"];
    titleText.text = [userDefaults stringForKey:@"mail3Title"];
    bodyText.text = [userDefaults stringForKey:@"mail3Body"];
...
- (void)viewWillDisappear:(BOOL)animated
{
    //stocking user data
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setObject:nameText.text forKey:@"mail3Name"];
    [userDefaults setObject:contentText.text forKey:@"mail3Address"];
    [userDefaults setObject:titleText.text forKey:@"mail3Title"];
    [userDefaults setObject:bodyText.text forKey:@"mail3Body"];
    AppDelegate *delegate = (AppDelegate *)[[UIApplication sharedApplication] delegate];
    delegate.name3 = nameText.text;
    delegate.address3 = contentText.text;
    delegate.title3 = titleText.text;
    delegate.body3 = bodyText.text;
